...
\begin{figure}[h]
    \centering
    \includegraphics[width=1\textwidth]{figuras/asociacion/Comentarios_beneficio_de_medicamento_propecia.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=1\textwidth]{figuras/asociacion/Comentarios_beneficio_de_medicamento_propecia_positivismo.png}
