...
- [`magrittr`](https://cran.r-project.org/web/packages/magrittr/magrittr.pdf) : Paquete ...

- [`plyr`](https://cran.r-project.org/web/packages/plyr/plyr.pdf) : Paquete ... 

- [`ggplot2`](https://cran.r-project.org/web/packages/ggplot2/ggplot2.pdf) : Paquete ...

- [`ROCR`](https://cran.r-project.org/web/packages/ROCR/ROCR.pdf) : Paquete ...

- [`RColorBrewer`](https://cran.r-project.org/web/packages/RColorBrewer/RColorBrewer.pdf) : Paquete ...

- [`NLP`](https://cran.r-project.org/web/packages/NLP/NLP.pdf) : Paquete ...

- [`wesanderson`](https://cran.r-project.org/web/packages/wesanderson/wesanderson.pdf) : Paquete ...

- [`devtools`](https://cran.r-project.org/web/packages/devtools/devtools.pdf) : Paquete ...  

- [`rlist`](https://cran.r-project.org/web/packages/rlist/rlist.pdf) : Paquete ...  

- [`quanteda`](https://cran.r-project.org/web/packages/quanteda/quanteda.pdf) : Paquete ...  

- [`tseries`](https://cran.r-project.org/web/packages/tseries/tseries.pdf) : Paquete ...  

- [`wordcloud`](https://cran.r-project.org/web/packages/wordcloud/wordcloud.pdf) : Paquete ...  

- [`dplyr`](https://cran.r-project.org/web/packages/dplyr/dplyr.pdf) : Paquete ...
...
terms_benefits_train <- ( idf_benefits_train <- log( ncol(tf_benefits_train) / ( 1 + rowSums(tf_benefits_train != 0) ) ) )
terms_effects_train <- ( idf_effects_train <- log( ncol(tf_effects_train) / ( 1 + rowSums(tf_effects_train != 0) ) ) )

terms_benefits_test <- ( idf_benefits_test <- log( ncol(tf_benefits_test) / ( 1 + rowSums(tf_benefits_test != 0) ) ) )
terms_effects_test <- ( idf_effects_test <- log( ncol(tf_effects_test) / ( 1 + rowSums(tf_effects_test != 0) ) ) )
...
ggplot() + 
 geom_bar(data=z_benefits_train[1:20,],aes(x=z_benefits_train$terms1_5_new_benefits_train[1:20], y=z_benefits_train$v_benefits_train[1:20]), stat='identity', position='dodge')
```
...
res <- cloud_negative_positive(d1)
...
res <- cloud_negative_positive(datos_train)
wordcloud(res$word, res$n, random.order = FALSE, colors = res$color, ordered.colors = TRUE)
