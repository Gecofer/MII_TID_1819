...
### 2.2.4. Cálculo de rating ponderado
...
for (i in 1:length(datos_train[[1]])){
  ...
  # Convertimos el valor de sideEffect a la misma escala que efectiveness, ya que sideEffect == 1 significa que no tiene efectos secundarios (lo cual es bueno), y efecctiveness == 1 significa que no es efectivo (lo cual no es bueno). Para ello realizamos la siguiente conversión:
...
### 2.2.5. Representación gráfica de los datos
...
### 2.2.7. Representación gráfica de las frecuencias
...
### 2.2.9. Eliminar signos de puntuación
...
### 2.2.10. Conversión de las mayúsculas en minúsculas
...
### 2.2.11. Eliminación de Stopwords
...
### 2.2.12. Agrupación de sinónimos
...
### 2.2.15. Borrar espacios en blanco innecesarios
