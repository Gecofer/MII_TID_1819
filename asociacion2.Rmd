...
benefits_rulesHighlyEffective <- sort(benefits_rulesHighlyEffective, decreasing = TRUE, na.last = NA, by = "confidence")
...
effects_rulesHighlyEffective <- sort(effects_rulesHighlyEffective, decreasing = TRUE, na.last = NA, by = "confidence")
...
```{r, echo=FALSE}
#Obtenemos las imágenes relacionadas con los comentarios sobre beneficios de los medicamentos
