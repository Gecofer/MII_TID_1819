...
Por último, vamos a aplicar una técnica más, la cuál se corresponde con una técnica de agrupamiento particional. Se correponde con la técnica *Density-based spatial clustering of applications* y consiste en dar una percepción más humana, donde se busca interpretar aquellas zonas muy densas rodeadas de zonas poco densas.
...
## 6.4. Agrupamiento de los fármacos en base a las opiniones de los usuarios
...
### 6.4.1. Clustering de Benefits Review
